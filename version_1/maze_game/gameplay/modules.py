...
class LevelMap:
    ...
    def load_from_file(self,
        ...
        # if map has coins to collect, changes exit block to be closed and inaccessible for player
        if "exit_coord" in locals():
            ...
            raise Exception("Maze described by file doesn't has exit")
...
class Player:
    ...
    def open_exit(self):
        """
        This method opens the doors when its executed
        """
    ...
    def destroy_block(self):
        """
        This method destroys a block that a player is currently facing, if it is possible to destroy it.
        """
